...
export const KEYS = {
  ...
  [KEY_IDS.SH]: { label: 'sh', input: 'sh(', value: 'sh(', type: KEY_TYPES.FUNCTION },
  [KEY_IDS.CH]: { label: 'ch', input: 'ch(', value: 'ch(', type: KEY_TYPES.FUNCTION },
  [KEY_IDS.TH]: { label: 'th', input: 'th(', value: 'th(', type: KEY_TYPES.FUNCTION },
